  ...
  <main class="auth-wrap">
    <div class="container auth-grid">
      <section class="panel">
        ...
        <p class="lead">Esta tela foi preparada para o fluxo da RA2. O formulário envia os dados ao endpoint de cadastro usando criptografia híbrida no navegador, antes que o servidor processe a requisição.</p>
        ...
        <div class="notice" style="margin-top:1.2rem;">
          No fluxo proposto, o dado original é reunido em JSON, criptografado com AES no cliente e a chave AES é protegida com RSA usando a chave pública do servidor.
        </div>
      </section>
      ...
      <section class="auth-card">
        ...
        <form id="cadastroForm" method="post" novalidate>
          <div class="form-grid">
            ...
            <div class="form-group">
              ...
              <input id="cpf" name="cpf" type="text" placeholder="Somente números" required>
            </div>
            ...
            <div class="form-group full">
              ...
              <input id="rua" name="rua" type="text" placeholder="Rua, avenida ou alameda" required>
            </div>
          ...
          <p class="help-text">Ao prosseguir, seus dados de cadastro serão protegidos antes do envio ao servidor.</p>
        ...
        <p class="auth-footer">Integração esperada: <code>../api/processa_cadastro_usuario.php</code> e <code>../api/public_key.php</code>.</p>
      </section>
    </div>
  </main>
