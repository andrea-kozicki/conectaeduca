...
, backslash, whitespace e metacaracteres.
...
def reconcile_target_env_with_live_storage(
    ...
    if (
        ...
        # Rollback bloqueado ou incompleto deixou o bind novo ativo. Nesse caso
        # o estado persistido PRECISA apontar para o mesmo target para que um
        # redeploy canônico não desvie /backup para o path anterior/default.
        persist_target_env(base, target)
