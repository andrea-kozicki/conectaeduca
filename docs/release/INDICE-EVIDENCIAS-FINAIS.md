...
Depois de revisar/sanitizar o diretório final:
...
- `SHA256SUMS`;
- `MANIFESTO-EVIDENCIAS.txt`.

O roteiro de comandos dos cenários está em `docs/seguranca/PENTEST-COMANDOS-S01-S13.md`.
