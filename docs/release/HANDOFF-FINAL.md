...
reproduzíveis**, não substitui a validação live. O estado operacional deve ser
confirmado pelas evidências da EP126 e pelo backlog canônico vigente.

Enrollment do Agent, FIM, evento sintético e YARA permanecem reservados para
demonstração controlada em aula.
